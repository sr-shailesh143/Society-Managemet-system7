                ...
                <div className=" d-flex bg-white ">
                    ...
                    <div className="col-12 col-md-9  ">
                        <div style={{ borderLeft: "2px solid #F6F8FB" }} className="navbar p-4 ">
                            ...
                            <Link className='link-tag' to={"/Community"} onClick={toggleFinancialSubmenu} > <div className='side-design' style={{ display: location.pathname === "/Community" ? "block" : "none" }}><SidebarMiniButton style={{ left: "-34px" }} /> </div>    <NavLink style={{ background: location.pathname === "/Community" ? "linear-gradient(90deg, #FE512E 0%, #F09619 100%)" : "", color: location.pathname === "/Community" ? "white" : "", textDecoration: "none" }} className=' d-flex gap-3 radious link-tag'>    <GiShirtButton className=' fs-3 mb-1' />Community {location.pathname === "/Community" ? <ArrowDropDownIcon style={{marginLeft:"70px"}}/> :"" }</NavLink> </Link>
                            {
