...
export default function CommunitiesDiscussion() {
                        ...
                        <div key={chat.id} className="chat-item" onClick={() => setSelectedChat(chat)}>
                            ...
                            <div className="chat-details">
                                <div className="chat-header">
                                    <h5>{chat.name}</h5>
                                    <span className="time">{chat.time}<br /><span><DoneAllIcon color="primary" /></span></span>
                                </div>
    ...
    <div className="question-form-container d-flex flex-column justify-content-center align-items-center">
        ...
        marginBottom:"-4px",
            ...
            <h5 className="text-start">Writing a good question
            </h5>
            <p className="text-start">You're ready to <span className='text-primary'>ask</span> a <span className='text-primary'>programming-related question</span> and this form will help guide you through the process.</p>
            <p className="text-start">Looking to ask a non-programming question? See <span className='text-primary'> the topics here</span> to find a relevant site.
            </p>
...
"
            ...
            />
            <button onClick={handleAddQuestion} className="btn btn-success w-10" style={{
